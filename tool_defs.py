...
TOOL_DECLARATIONS = [
    {
        ...
        "description": "Windows ana ses seviyesini ayarlar veya sesi açıp kapatır. Kullanıcı 'sesi yüzde 30 yap', 'sesi 50 yap', 'sesi aç', 'sesi kapat' dediğinde kullan.",
        "parameters": {
            "type": "OBJECT",
            "properties": {
                "action": {"type": "STRING", "description": "set | mute | unmute"},
                "percent": {"type": "NUMBER", "description": "0-100 arası ana ses seviyesi; set için zorunlu"}
            },
            "required": ["action"]
        }
    },
